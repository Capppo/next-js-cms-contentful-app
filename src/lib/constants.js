...
export const FILE_EXTENTIONS =['avi','mp4','mkv']
export const APP_TAG_DEFAULT_KEY_VALUE = "Year: default"
export const APP_KEY_MASTER = "Key: Master"
export const APP_GENRE_COMING_SOON_ID = "genreComingSoon"
